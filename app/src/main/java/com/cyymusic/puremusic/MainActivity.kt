package com.cyymusic.puremusic

import android.os.Bundle
import android.util.Log
import androidx.databinding.DataBindingUtil
import com.cyymusic.puremusic.bridge.data.config.Configs
import com.cyymusic.puremusic.bridge.state.MainActivityViewModel
import com.cyymusic.puremusic.databinding.ActivityMainBinding
import com.cyymusic.puremusic.ui.base.BaseActivity
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedViewModel.activityCanBeClosedDirectly.observe(this) {
            ...
            Log.d(
                Configs.TAG,
                if (it) "中控中心 我知道了，原来播放条被收缩了" else "中控中心 我知道了，原来播放条被展开了"
            )
            // ... 业务逻辑的
        }
    ...
    override fun onBackPressed() {
        ...
        mSharedViewModel.backListMusic.value = true// nav().navigateUp() // back键的时候，返回上一个界面
        mSharedViewModel.backSearchFragment.value = true
    }
}